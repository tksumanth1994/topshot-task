      ...
      <div className="hero-body px-0">
        <div className={`container ${styles.details}`}>
          <a
            ...
            target="_blank"
            className={`title is-size-4 has-text-weight-bold ${styles.title}`}
            rel="noreferrer">
            {repository.owner.login}/{repository.name}
          </a>
          <p className="is-size-6">{repository.description}</p>
          <div className="is-hidden-tablet is-flex is-justify-content-start is-align-items-center pt-3">
            <p className="is-size-7 is-flex is-align-items-center has-text-grey-lighter">
              <svg
            ...
            <p className="is-size-7 is-flex is-align-items-center has-text-grey-lighter ml-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 16 16"
                width="16"
          ...
          <div
            className={`is-hidden-mobile is-flex is-justify-content-center is-align-items-start ${styles.stats}`}>
